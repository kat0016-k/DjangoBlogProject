...
def show_computer(request):
    return render(request,'computer.html',{'form':''})

def show_water(request):
    return render(request,'water.html',{'form':''})

def show_weeds(request):
    return render(request,'weeds.html',{'form':''})
...
def show_cake(request):
    return render(request,'cake.html',{'form':''})

def show_socialising(request):
    return render(request,'socialising.html',{'form':''})
